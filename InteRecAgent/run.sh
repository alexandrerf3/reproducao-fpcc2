...
API_BASE="http://localhost:3003/v1" # [https://xxxx.azure.com, https://api.openai.com/v1]
API_VERSION="2023-03-15-preview"
API_TYPE="open_ai" # ['open_ai', 'azure']
engine="vicuna-7b-v1.5"   # model name for OpenAI or deployment name for Azure OpenAI. GPT-4 is recommended.
bot_type="completion" # model type, ["chat", "completetion"]. For gpt-3.5-turbo and gpt-4, it should be "chat". For text-davinci-003, it should be "completetion" 
